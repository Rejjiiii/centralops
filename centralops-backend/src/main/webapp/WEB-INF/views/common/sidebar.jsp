<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <!-- Sidebar -->
  <aside class="bg-white shadow-lg transition-transform duration-300 ease-in-out fixed inset-y-0 left-0 z-50 w-64 flex flex-col
    ...
    <div class="p-4 border-t">
      <a href="${pageContext.request.contextPath}/logout" onclick="logout(); return false;"
        class=" flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors hover:bg-red-50">
  ...
  <script>
    function logout() {
      ...
      window.location.href = `${appContext}/logout`; // this invalidates session
    }
  </script>